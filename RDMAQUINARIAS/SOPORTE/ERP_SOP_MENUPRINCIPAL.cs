...
{
    public partial class ERP_SOP_MENUPRINCIPAL : Form
    {
        public ERP_SOP_MENUPRINCIPAL()
        {
            InitializeComponent();
        }
        NEG_SOP_LOGIN neg = new NEG_SOP_LOGIN();
        private void ERP_SOP_MENUPRINCIPAL_Load(object sender, EventArgs e)
        {
        ...
        private void subMenuClick(object sender, EventArgs e)
        {
            try
            {
                ...
                if (sender.ToString().Trim() == "Gestionar Empresas")
                {
                    ...
                    frm = new ADMINISTRACION.ERP_ADM_EMPRESA();
                    frm.MdiParent = this;
                    frm.Show();
                }
                ...
                {
                    CLASES.ERP_GLOBALES.formpermisos = "Gestionar Módulos";
                    frm = new SOPORTE.ERP_SOP_MODULOS();
                    frm.MdiParent = this;
                    frm.Show();
                }
                ...
                {
                    CLASES.ERP_GLOBALES.formpermisos = "Accesos de Usuario";
                    frm = new SOPORTE.ERP_SOP_PERMISOS();
                    frm.MdiParent = this;
                    frm.Show();
                }
                if (sender.ToString().Trim() == "Gestionar Empresas y Sedes")
                {
                    CLASES.ERP_GLOBALES.formpermisos = "Gestionar Empresas y Sedes";
                    frm = new ERP_ADM_EMPRESA();
                    frm.MdiParent = this;
                    frm.Show();
                }
        ...
        private void subSubMenuClick(object sender, EventArgs e)
        {
